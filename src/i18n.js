export const T = {
  et: {
    ...
    lbPageTitle: 'Otseülekanne', lbRefresh: 'Värskenda', lbBackToGame: 'Tagasi mängu',
    lbViewLink: 'Vaata edetabelit',
  ...
  en: {
    ...
    lbPageTitle: 'Live results', lbRefresh: 'Refresh', lbBackToGame: 'Back to game',
    lbViewLink: 'View leaderboard',
    restart: 'Start over',
